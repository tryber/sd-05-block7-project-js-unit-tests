...
/*
  ...
  - Uma chave `pay` que, quando chamada, invoca uma função que soma o valor de todos os pedidos e
  dá o preço com acréscimo de 10%.

  IMPORTANTE: COMECE PELO TESTE 1 DO ARQUIVO `tests/restaurant.spec.js` E NÃO PELO PASSO 1 DESTE ARQUIVO!
*/

// PASSO 1: Crie uma função `createMenu()` que, dado um objeto passado por parâmetro, retorna um objeto com
// o seguinte formato: { fetchMenu: objetoPassadoPorParametro }.
//
...
const createMenu = objeto => {
  ...
  'fetchMenu' : () => objeto,
  'consumption' : [],
  'order' : request => menuObjeto.consumption.push(request),
  }
  return menuObjeto;
};
