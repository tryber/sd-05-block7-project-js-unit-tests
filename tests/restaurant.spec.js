...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    //assert.deepStrictEqual(createMenu({objetoQualquer: 'valor qualquer'}), { fetchMenu: {objetoQualquer: 'valor qualquer'} });
    ...
    // ```
    assert.deepStrictEqual(createMenu({objetoQualquer: 'valor qualquer'}).consumption, []);
    ...
    // ```
    let objRestaurant = createMenu({objetoQualquer: 'valor qualquer'});
    assert.strictEqual(objRestaurant.order('coxinha').consumption.includes('coxinha'), true);
    ...
    // ```
    assert.deepStrictEqual(objRestaurant.order('agua') && objRestaurant.order('sopa') &&objRestaurant.order('sashimi') && objRestaurant.consumption, ['coxinha', 'agua', 'sopa', 'sashimi']);
