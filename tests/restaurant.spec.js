...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    const objetoRetornado = createMenu(objetoQualquer);
    assert.deepStrictEqual(objetoRetornado.fetchMenu, {food: {'coxinha': 3.90, 'sanduiche': 9.90},
    drink: {'agua': 3.90, 'cerveja': 6.90}});
    ...
    assert.deepStrictEqual(objetoRetornado.consumption, ["coxinha", "agua", "sanduiche", "cerveja"]);
    ...
    objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
    assert.deepStrictEqual(objetoRetornado.consumption, ["coxinha", "agua", "sanduiche", "cerveja", 'coxinha', 'agua', 'coxinha']);
    ...
    // ```
    assert.strictEqual(objetoRetornado.pay(), 39.93);
