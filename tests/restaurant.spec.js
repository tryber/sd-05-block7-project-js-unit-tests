...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepStrictEqual(createMenu(myMenu).fetchMenu, { fetchMenu: myMenu }, 'not the right answer');
    ...
    // ```
    assert.deepStrictEqual(Object.keys(createMenu({ food: {}, drink: {} }).fetchMenu.fetchMenu), ['food', 'drink']);
    ...
    // ```
    assert.deepStrictEqual(createMenu({ food: {}, drink: {} }).fetchMenu.fetchMenu, { food: {}, drink: {} });
    ...
    // ```
    const myOrder = createMenu(myMenu)
    
    assert.deepStrictEqual(myOrder.order('coxinha'), ['coxinha']);
    ...
    myOrder.order('agua');
    myOrder.order('sopa');
    myOrder.order('cerveja');
    assert.deepStrictEqual(myOrder.consumption, ['coxinha', 'agua', 'sopa', 'cerveja']);
    ...
    // ```
    myOrder.order('coxinha');
    assert.deepStrictEqual(myOrder.consumption, ['coxinha', 'agua', 'sopa', 'cerveja', 'coxinha']);
    ...
    // ```
    assert.strictEqual(myOrder.pay(), 31.35);
