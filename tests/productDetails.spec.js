...
describe('#productDetails', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    assert.deepEqual(typeof productDetails("Alcool gel", "Máscara")[0] && typeof productDetails("Alcool gel", "Máscara")[1], 'object');
    ...
    assert.deepStrictEqual(product1.includes("123", product1.length-3) && product2.includes("123", product2.length-3), true);
  });
});
